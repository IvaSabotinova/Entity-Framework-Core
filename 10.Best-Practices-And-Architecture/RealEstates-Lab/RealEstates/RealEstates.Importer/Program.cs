...
namespace RealEstates.Importer
{
    internal class Program
    {
        ...
        public static void ImportJsonFile(string fileName)
        {
            ...
            {
                propertiesService.Add(property.District, property.Floor, property.TotalFloors, property.Size, property.YardSize, property.Year, property.Type, property.BuildingType, property.Price);
                Console.Write(".");
            }
        }
    }
