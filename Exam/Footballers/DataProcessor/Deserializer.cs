        ...
        public static string ImportCoaches(FootballersContext context, string xmlString)
        {
            ...
            foreach (CoachWithFootballersInputModel dtoCoach in dtoCoaches)
            {
                ...
                foreach (FootballerOfCoachInputModel dtoFootballer in dtoCoach.Footballers)
                {
                    ...
                    bool IsValidContractStartDate = DateTime.TryParseExact(dtoFootballer.ContractStartDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime contractStarDate);

                    bool IsValidContractEndDate = DateTime.TryParseExact(dtoFootballer.ContractEndDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime contractEndDate);
