    ...
    public class Deserializer
    {
        ...
        public static string ImportPrisonersMails(SoftJailDbContext context, string jsonString)
        {
            ...
            foreach (PrisonerMailInputModel dtoPrisoner in dtoPrisoners)
            {
                ...
                bool IsValidIncarcerationDate = DateTime.TryParseExact(dtoPrisoner.IncarcerationDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, 
                ...
                DateTime? prisonerReleaseDate = DateTime.TryParseExact(dtoPrisoner.ReleaseDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, 
                    DateTimeStyles.None, out DateTime releaseDate) ? (DateTime?)releaseDate : null;
